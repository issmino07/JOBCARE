...
@Component({
  ...
  templateUrl: './capacidades-especiales.component.html',
  styleUrls: ['./capacidades-especiales.component.css']
})
export class CapacidadesEspecialesComponent implements OnInit {
