...
@Component({
  ...
  templateUrl: './capacidades-especiales-empleador.component.html',
  styleUrls: ['./capacidades-especiales-empleador.component.css']
})
export class CapacidadesEspecialesEmpleadorComponent implements OnInit {
  ...
  cate ='CUIDADOS CAPACIDADES ESPECIALES';
  rol ='EMPLEADOR_ROLE';
  ...
  public registerForm = this.fb.group({
    ...
    descripcion:['',[Validators.required,Validators.minLength(30), Validators.maxLength(150)]],
