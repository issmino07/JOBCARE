...
@Component({
  ...
  templateUrl: './mascota-empleador.component.html',
  styleUrls: ['./mascota-empleador.component.css']
})
export class MascotaEmpleadorComponent implements OnInit {
