...
@Component({
  selector: 'app-asistencia-empleador',
  templateUrl: './asistencia-empleador.component.html',
  styleUrls: ['./asistencia-empleador.component.css']
})
export class AsistenciaEmpleadorComponent implements OnInit {
